<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Favorites.aspx.cs" Inherits="ProiectDAW.Favorites" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:TextBox ID="TextBoxUser"  visible="false" runat="server"></asp:TextBox>
    ...
    <div class="gridsh" >
       ...
       <asp:GridView ID="GridView22" runat="server" OnRowCommand="GridView22_RowCommand" 
           AllowPaging="True" emptydatatext="You have no Favorites" style=" margin-top: 6px; margin-left:50px; margin-bottom:150px;" Width="720px " AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1">
         <Columns>
            ...
            <asp:HyperLinkField DataNavigateUrlFields="Id" Text = "" ControlStyle-CssClass="fa fa-download" DataNavigateUrlFormatString = "~/FileCS.ashx?Id={0}" HeaderText="" />
                <asp:TemplateField ShowHeader="False">
                           <ItemTemplate>
                              <div id="some-div">             
                                   <asp:LinkButton ID="LinkButton4"  class="fa fa-heart" aria-hidden="false" style="color: #ff4d94; font-size:15px; margin-left:5px;" runat="server" 
                            ...
                            <EditRowStyle  Width="10px"></EditRowStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ...
        SelectCommand="SELECT t.id, t.Title, t.Artist, t.song_image FROM tblFiles t INNER JOIN Favorites AS f ON  f.track_id = t.id WHERE f.user_id = @user "
